...
(function(tg){
	...
	var TG_Date = tg.TG_Date, 
		...
		if (typeof window.Modernizr == "object") {
			CLICKORTOUCH = Modernizr.touch ? "touchstart" : "click";
		} else {
			CLICKORTOUCH = jQuery.support.touch ? "touchstart" : "click";
		}
  ...
  registerTitles : function () {
	...
	*/
	...
	passesFilters : function (ev, zoomLevel) {
		...
		if  (zoomLevel > 0 && ((zoomLevel < ev.low_threshold) || (zoomLevel > ev.high_threshold))) {
			return false;
		}
	...
	*/  
	createEventLinksMenu : function (linkage) {
		...
		if (typeof(linkage) == "string") {
			...
			html = "<li><a href='" + linkage + "' target='_blank'>详细信息</a></li>"
